...
Route::controller(RegisterController::class)->group(function () {
   Route::post('/login/google/register/recaptcha', 'registerRecaptcha')->name('registerRecaptcha');
});
...
Route::post('/packages/wallets/encrypt', [WalletController::class, 'secured_encrypt_public'])->name('notify.encript');
...
Route::prefix('wallets')->middleware('auth')->name('wallets')->group(function () {
   Route::controller(WalletController::class)->group(function () {
      ...
      Route::post('/edit/active', 'editActive')->name('.editActive');
...
Route::prefix('admin')->middleware(['auth', 'is.admin'])->name('admin')->group(function () {
   ...
   Route::prefix('reports')->name('.reports')->group(function () {
      Route::controller(ReportsAdminController::class)->group(function () {
         ...
         Route::get('/transactions', 'transactions')->name('.transactions');
         Route::get('/wallets/balance', 'walletsBalance')->name('.walletsBalance');
