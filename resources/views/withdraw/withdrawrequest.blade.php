    ...
    <section id="withdrawrequest" class="content">
      <div class="fade">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <h1 class="up font">@lang('withdraw.withdraw_fund')</h1>
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm pt-3" style="width: 250px;">
                      <div class="input-group-append">
                        <button type="button" class="btn btn-primary btn-sm rounded-pill up font" style="width: 220px;"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body my-3">
              <div class="amount">@lang('withdraw.current_balance'): <b>{{ number_format($user->getTotalBanco(), 2, ',', '.') }}</b>
              </div>
                ...
                <div class="my-5">
                  ...
                  <div class="input-group ">
                    ...
                    <input type="number" name="value" id="value" class="form-control"
                      aria-label="@lang('withdraw.amount')" id="recipient-name" min="50" max="10000"
