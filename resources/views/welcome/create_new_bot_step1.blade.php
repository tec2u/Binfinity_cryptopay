...
@endif
                            ...
                            <div class="card-body">
                              <form action="{{ route('step.post.2') }}" method="post">
                                @csrf
                                <input type="hidden" name="id_package" value="{{ $package->id }}">
                                <button class="btn btn-warning ms-md-2 btnnav" type="submit">SELECT AND GO TO STEP
                                  2</button>
                              </form>
                            </div>
                        </div>
              ...
              {{-- <a href="/create_new_bot_step2"><button class="btn btn-warning ms-md-2 btnnav">STEP 2</button></a> --}}
